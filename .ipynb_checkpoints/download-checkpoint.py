...
if __name__ == "__main__":
    use_auth_token = "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"

    repo_id = "microsoft/phi-2"
    local_dir = "LLMmodel/phi-2" # replace "xxx" with a real path and make sure that it has at least 3G of space
    ...
    local_dir = "LLMmodel/bge-large-en-v1.5"
    download_from_hf_hub(repo_id=repo_id, use_auth_token=use_auth_token, local_dir=local_dir)
