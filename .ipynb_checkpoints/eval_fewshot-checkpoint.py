...
parser.add_argument('--model', type=str, default='LLMmodel/phi-2', help="")
parser.add_argument('--embedder', type=str, default="LLMmodel/bge-large-en-v1.5")
parser.add_argument('--output_path', type=str, default="/home/featurize/output/")
...
def get_arc_problems(data_path="data/ARC-Challenge-test.jsonl"):
    dataset = []
...
def generate_prompt(question, candidate_answers, prompt_type, N,
    ...
    if top_k: # task 5
        ...
        similarity = np.dot(question_embeddings, np.transpose(demonstration_embeddings))
    ...
    template = "Assuming you are an expert who are good at doing multiple choice, you can think logically and can learn from the examples I give you. If you finish task wonderfully, I will give you 10000 dollars as tips"
...
def main():
    ...
    for i in tqdm(range(num_samples), ncols=0, total=num_samples):
        ...
        with torch.no_grad():
            ...
            likelihood = outputs.loss * (-1) 
            # log_likelihood = torch.log(outputs.loss)
